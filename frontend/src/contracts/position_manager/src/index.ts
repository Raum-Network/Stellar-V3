...
export const networks = {
  testnet: {
    ...
    contractId: "CBNI32C7WLRU5QG7B65RGQM5KYSO45DZHA4CGUAPS3NS62YUEPQD4ZHA",
  }
} as const
 ...
 */
export type DataKey = {tag: "Admin", values: void} | {tag: "Factory", values: void} | {tag: "Position", values: readonly [u32]};
...
export interface PositionData {
  fee_growth_inside_0_last: readonly [u128, u128];
  fee_growth_inside_1_last: readonly [u128, u128];
  fees_owed_0: u128;
  fees_owed_1: u128;
  liquidity: u128;
  pool: string;
...
export interface Client {
   ...
   */
  burn: ({pool, to, token_id, liquidity}: {pool: string, to: string, token_id: u32, liquidity: u128}, options?: MethodOptions) => Promise<AssembledTransaction<readonly [u128, u128]>>

  /**
   * Construct and simulate a mint transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Mint a new position NFT
   */
  mint: ({token_a, token_b, fee, to, tick_lower, tick_upper, liquidity}: {token_a: string, token_b: string, fee: u32, to: string, tick_lower: i32, tick_upper: i32, liquidity: u128}, options?: MethodOptions) => Promise<AssembledTransaction<readonly [u128, u128, u32]>>
   ...
   */
  collect: ({pool, to, token_id}: {pool: string, to: string, token_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<readonly [u128, u128]>>
   ...
   */
  balance_of: ({owner}: {owner: string}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>

  /**
   * Construct and simulate a initialize transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  initialize: ({admin, factory, name, symbol}: {admin: string, factory: string, name: string, symbol: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_position: ({token_id}: {token_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<PositionData>>
  ...
  /**
   * Construct and simulate a get_owned_tokens transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Legacy helper for existing frontend usage.
   */
  get_owned_tokens: ({owner}: {owner: string}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  refresh_position_ttl: ({token_id}: {token_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   * Legacy helper for existing frontend usage.
   */
  set_approval_for_all: ({owner, operator, approved}: {owner: string, operator: string, approved: boolean}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a get_owned_tokens_page transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Paginated token lookup to keep per-call resource usage bounded.
   * `cursor` is the 0-based owner token index.
   */
  get_owned_tokens_page: ({owner, cursor, limit}: {owner: string, cursor: u32, limit: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAB1TdG9yYWdlIGtleXMgZm9yIHRoZSBjb250cmFjdAAAAAAAAAAAAAAHRGF0YUtleQAAAAADAAAAAAAAAAAAAAAFQWRtaW4AAAAAAAAAAAAAAAAAAAdGYWN0b3J5AAAAAAEAAAAAAAAACFBvc2l0aW9uAAAAAQAAAAQ=",
        "",
        "AAAAAAAAAB5CdXJuIGxpcXVpZGl0eSBmcm9tIGEgcG9zaXRpb24AAAAAAARidXJuAAAABAAAAAAAAAAEcG9vbAAAABMAAAAAAAAAAnRvAAAAAAATAAAAAAAAAAh0b2tlbl9pZAAAAAQAAAAAAAAACWxpcXVpZGl0eQAAAAAAAAoAAAABAAAD7QAAAAIAAAAKAAAACg==",
        "",
        ...
        "AAAAAAAAAChDb2xsZWN0IGFjY3VtdWxhdGVkIGZlZXMgZnJvbSBhIHBvc2l0aW9uAAAAB2NvbGxlY3QAAAAAAwAAAAAAAAAEcG9vbAAAABMAAAAAAAAAAnRvAAAAAAATAAAAAAAAAAh0b2tlbl9pZAAAAAQAAAABAAAD7QAAAAIAAAAKAAAACg==",
        ...
        "AAAAAAAAACpMZWdhY3kgaGVscGVyIGZvciBleGlzdGluZyBmcm9udGVuZCB1c2FnZS4AAAAAAApiYWxhbmNlX29mAAAAAAABAAAAAAAAAAVvd25lcgAAAAAAABMAAAABAAAABA==",
        "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAABAAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAdmYWN0b3J5AAAAABMAAAAAAAAABG5hbWUAAAAQAAAAAAAAAAZzeW1ib2wAAAAAABAAAAAA",
        "AAAAAAAAAAAAAAAMZ2V0X2FwcHJvdmVkAAAAAQAAAAAAAAAIdG9rZW5faWQAAAAEAAAAAQAAA+gAAAAT",
        "AAAAAAAAACBHZXQgcG9zaXRpb24gZGF0YSBmb3IgYSB0b2tlbiBJRAAAAAxnZXRfcG9zaXRpb24AAAABAAAAAAAAAAh0b2tlbl9pZAAAAAQAAAABAAAH0AAAAAxQb3NpdGlvbkRhdGE=",
        ...
        "AAAAAAAAACpMZWdhY3kgaGVscGVyIGZvciBleGlzdGluZyBmcm9udGVuZCB1c2FnZS4AAAAAABBnZXRfb3duZWRfdG9rZW5zAAAAAQAAAAAAAAAFb3duZXIAAAAAAAATAAAAAQAAA+oAAAAE",
        ...
        "AAAAAAAAADtFeHRlbmQgYSBwb3NpdGlvbiBlbnRyeSBUVEwgcHJlZW1wdGl2ZWx5IHRvIGF2b2lkIGFyY2hpdmFsLgAAAAAUcmVmcmVzaF9wb3NpdGlvbl90dGwAAAABAAAAAAAAAAh0b2tlbl9pZAAAAAQAAAAA",
        "AAAAAAAAACpMZWdhY3kgaGVscGVyIGZvciBleGlzdGluZyBmcm9udGVuZCB1c2FnZS4AAAAAABRzZXRfYXBwcm92YWxfZm9yX2FsbAAAAAMAAAAAAAAABW93bmVyAAAAAAAAEwAAAAAAAAAIb3BlcmF0b3IAAAATAAAAAAAAAAhhcHByb3ZlZAAAAAEAAAAA",
        "",
        ...
        "",
  ...
  public readonly fromJSON = {
    burn: this.txFromJSON<readonly [u128, u128]>,
        mint: this.txFromJSON<readonly [u128, u128, u32]>,
        ...
        get_owned_tokens: this.txFromJSON<Array<u32>>,
        get_owner_token_id: this.txFromJSON<u32>,
        is_approved_for_all: this.txFromJSON<boolean>,
        refresh_position_ttl: this.txFromJSON<null>,
        set_approval_for_all: this.txFromJSON<null>,
        get_owned_tokens_page: this.txFromJSON<Array<u32>>
  }
}